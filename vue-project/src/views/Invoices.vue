      ...
      <div class="center">
          <v-row style="display: flex; justify-content: right; max-width: 80%;" class="center">
              <v-col cols="12" md="3" class="mr-16 justify-end" max-width="400px">
                  ...
                  <v-card>
                      <v-text-field :loading="loading" density="compact" variant="solo" label="Search .." append-inner-icon="mdi-magnify" single-line hide-details @click:append-inner="onClick" class="text-field-right"></v-text-field>
                  </v-card>
              </v-col>
          </v-row>
      </div>
